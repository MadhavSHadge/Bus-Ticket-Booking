...
public class BusReservationAndTicketingSystem {
    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("madhavhadge") && password.equals("smh$8080")){
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)Narayangaon  | Rs.20  |   "+available[1]+"   **");
    					System.out.println("** 2.)Manchar      | Rs.30  |   "+available[2]+"   **");
    					System.out.println("** 3.)Chakan       | Rs.60  |   "+available[3]+"   **");
    					System.out.println("** 4.)Bhosari      | Rs.100 |   "+available[4]+"   **");
    					System.out.println("** 5.)Shivaji Nagar| Rs.160 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
    					...
    					String dest[] = { " ", "Narayangaon", "Manchar", "Chakan", "Bhosari", "Shivaji Nagar"};
    					double fare[] = { 0,20,30,40,100,160};
    			...
    			for(y=1; y==1;){
    				...
    				if (yn.equalsIgnoreCase("y")){
    					...
    					System.out.println("\nThank You for using Madhav Inc. for Ticket Generation!!!");
    					break;
    				}
    				else{
    					System.out.println("Invalid Input!!!");
